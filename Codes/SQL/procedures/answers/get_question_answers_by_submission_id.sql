CREATE OR REPLACE FUNCTION get_question_answers_by_submission_id(
...
AS $$
BEGIN
    CALL check_user_permission(p_current_user_id, 'get_question_answers_by_submission_id');
    ...
    LEFT JOIN FORMS f ON f.formId = q.formId
