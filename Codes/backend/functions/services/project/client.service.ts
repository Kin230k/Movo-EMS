...
async createClient(
  ...
  const entity = new Client(name, contactEmail, contactPhone, undefined, logo, company);
...
async updateClient(
  ...
  const entity = new Client(name, contactEmail, contactPhone, clientId, logo, company);
  await this.mapper.save(entity);
}
